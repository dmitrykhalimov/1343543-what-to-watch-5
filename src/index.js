...
// 4. В form-review и sign-in, приходится передавать по одному символа в initialState, иначе крашатся тесты. Нет идей как это поправить.
// UPD.to.4 Переколхозил signIn - теперь initialState приходит пропсом, а значит можно из теста его имитриовать. По-моему это странно портить компонент чтобы работали e2e-тесты, но критерий Д26 - беспощаден. Если ок, аналогично переделаю form-review.
